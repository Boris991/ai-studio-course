...
| ✏️ | [MCP-сервера для работы с arXiv и medrXiv](5-mcp/servers/README.md) | Для запуска примера выше вам необходимо развернуть эти сервера на виртуальной машине (возможно, это уже сделано преподавателем) | |
